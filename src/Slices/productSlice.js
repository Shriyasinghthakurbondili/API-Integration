...
export function getFallbackImage(title = "", category = "") {
  ...
  const map = [
    ...
    { keys: ["backpack", "travel backpack"],              url: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&auto=format&fit=crop" },
    { keys: ["bag", "handbag"],                           url: "https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&auto=format&fit=crop" },
